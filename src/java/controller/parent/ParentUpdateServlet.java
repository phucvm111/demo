...
public class ParentUpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String parentdob = request.getParameter("parentdob");
        String parentgender = request.getParameter("parentgender");
        ...
        String parentavatar = request.getParameter("parentavatar");
        ...
        Account newAcc = new Account(acc.getAccountID(),parentfirstname,parentlastname,newGender,acc.getEmail(),acc.getPassword(),parentdob,parentphonenumber,parentaddress,parentavatar,acc.getRole());
        AccountDAO adao = new AccountDAO();
        adao.updateParent(newAcc);
        session.setAttribute("account", adao.getAccountByID(newAcc.getAccountID()));
